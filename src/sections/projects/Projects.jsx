        ...
        <div className="projects" id="projects">
            ...
            <div className="projectsList">
                <ProjectComponent 
                    ...
                    pjTech={['JS', 'HTML', 'CSS']}
                    pjImg={'/src/assets/projects/digital-clock.png'}
                ...
                <ProjectComponent 
                    ...
                    pjImg={'/src/assets/projects/tictactoe.png'}
                ...
                <ProjectComponent
                    ...
                    pjTech={['JS', 'HTML', 'CSS']}
                    pjImg={'/src/assets/projects/hackathon.png'}
                ...
                <ProjectComponent
                    pjName={'Portfolio'} 
                    pjTech={['REACT', 'HTML', 'CSS']}
                    pjImg={'/src/assets/projects/portfolio.png'}
